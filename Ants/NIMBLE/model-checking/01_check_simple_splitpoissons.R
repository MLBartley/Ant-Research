## check changing Y_t|X_t from poissoin to split poisson as
...
x.init <- x.init #simulated in 01_check_simple
...
## Simulate latent states and events
 ...
 model$simulate("y_l", includeData = TRUE)
 model$simulate("y_diff")

 plot(1:seconds, model$y_l, type = "l")
 plot(1:seconds, model$y_diff, type = "l")
...
write.csv(samples, file =  paste("./NIMBLE/data-mcmc/", "simple_testmodel_sepypois", "-",
