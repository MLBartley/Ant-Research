...
pen_results[[r]] <- penalty_diagnosis(t(temp_results)[-1, ], 
                                ...
                                fig_name = "optimizedMSPE", penalty = range[r])
 }
...
#out of curiosity
maxMSPE_3 <- MSPE_results_THREE[which.max(MSPE_results$MSPE_THREE), ]


print(compare_plot_3)
print(compare_plot_3 + ylim(.0177, .019)) #limits chosen via observation of first plot
...
pen3_results[[r]] <- penalty_diagnosis(t(temp_results)[, -1 ], 
                                      ...
                                      chamber = "queen", 
                                      Time = hours * 60 * 60, fig_path = path,
                                fig_name = "optimizedMSPE3", penalty = range_3[r])
 }
