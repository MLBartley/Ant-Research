...
#DT.penalize.mcmc.troph = function(y.data,states, ant.file, hours, a, b, c, d, penalty,n.mcmc){
  ...
  lambda.param.est = apply(lambda.param, 1, bm) 
  lambda.param.var = apply(lambda.param, 1, quantile, probs = c(0.025, 0.975),  na.rm = TRUE) 
  
  gamma.param.est = apply(gamma.param, 1, bm) 
  gamma.param.var = apply(gamma.param, 1, quantile, probs = c(0.025, 0.975),  na.rm = TRUE) 
