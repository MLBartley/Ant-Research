...
n = 1 + #no interactions
  ...
  (ant * (ant-1) * (ant-2) * (ant-3))/2/2/2 +  #concurrent two way interactions, 4+ ants

  #concurrent three way interactions, 6+ ants
...
plot(0,0,xlab="t",ylab="State",ylim=c(1,max(X)),xlim=c(0,Ti),type="n")
