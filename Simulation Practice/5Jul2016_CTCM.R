...
M = matrix(c(.995, .005, .005, .995), 2, 2)
...
#http://127.0.0.1:39962/graphics/plot_zoom_png?width=1101&height=327 
...
params[1:2, 1] = c(.015, .015)
params[3:4, 1] = c(.015, .015)
...
for(l in 2:n.mcmc){
  ...
  #   sigma = c(0, 0, 0, 0)
  #   for(v in 1:4){
  #     sigma[v] = ((2.38 ^ 2) / 4) * var(params[v, 1:(l - 1)])
  #   }
  # 
