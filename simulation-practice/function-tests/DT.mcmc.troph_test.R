...
theta = matrix(data = c(5500, 1, 1, 5500), nrow = 2, ncol = 2, byrow = T) 
test.bin1c = DT.mcmc.troph(y.data = sim30$inter.persec, ant.file = sim30,
                          title = "test", a = .1, b = .5, c = .1, d = .5, 
                          theta = theta, states = 2, n.mcmc = 10000,
                          delta.t = 1, hours = 4)

theta = matrix(data = c(5700, 1, 1, 5700), nrow = 2, ncol = 2, byrow = T) 
test.bin1d = DT.mcmc.troph(y.data = sim30$inter.persec, ant.file = sim30,
                          title = "1900,1", a = .1, b = .5, c = .1, d = .5, 
                          theta = theta, states = 2, n.mcmc = 10000,
                          delta.t = 1, hours = 4)

theta = matrix(data = c(5800, 1, 1, 500), nrow = 2, ncol = 2, byrow = T) 
test.bin1e = DT.mcmc.troph(y.data = sim30$inter.persec, ant.file = sim30,
                          title = "5800,1", a = .1, b = .5, c = .1, d = .5, 
                          theta = theta, states = 2, n.mcmc = 5000,
                          delta.t = 1, hours = 4)


theta = matrix(data = c(5650, 1, 1, 5650), nrow = 2, ncol = 2, byrow = T) 
test.bin1f = DT.mcmc.troph(y.data = sim30$inter.persec, ant.file = sim30,
